...
public class AIMovementStats : ScriptableObject
{
    ...
    [Range(0.01f, 2f)] public float WallDetectionRayHeightMulltiplier = 0.9f;
    ...
    [Header("Power")]
    [Range(1f, 10f)] public float Power = 8f;
    ...
    [Range(0.01f, 0.05f)] public float GhostDelaySeconds = 0.04f;

    [Header("Dash Cancel Time")]
    [Range(0.01f, 5f)] public float DashGravityOnReleaseMultiplier = 0.4f;
